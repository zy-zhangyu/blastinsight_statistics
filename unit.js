...
(async () => {
    ...
    document.getElementById("balance").innerText = "Balance (ETH): " + balance.toFixed(6) + " ETH" + "\n";
    document.getElementById("balanceusd").innerText = "Balance (USD): $" + balanceUsd.toFixed(2) + "\n";
    document.getElementById("totalvalue").innerText = "Wallet turnover (ETH): " + totalValue.toFixed(4) + " ETH" + "\n";
    document.getElementById("totalvalueusd").innerText = "Wallet turnover (USD): $ " + totalValueusd.toFixed(2) + " USD" + "\n";
    document.getElementById("balancechangelastmonth").innerText = "Balance change in last month: " + balanceChange.toFixed(4) + " ETH" + "\n";
    document.getElementById("balancechangelastyear").innerText = "Balance change in last year: " + balanceChangeLastYear.toFixed(4) + " ETH" + "\n";
    document.getElementById("walletage").innerText = "Wallet age: " + walletAgeInMonths + " months" + "\n";
    document.getElementById("txsucessnumber").innerText = "txsucessnumber: " + transactionsucessnumber + "\n";
    document.getElementById("rejectedTxNumber").innerText = "rejectedTxNumber: " + rejectedTxNumber + "\n";
    document.getElementById("averageInterval").innerText = "averageInterval: " + averageInterval.toFixed(2) + "\n";
    document.getElementById("maxInterval").innerText = "maxInterval: " + maxInterval.toFixed(2) + "\n";
    document.getElementById("timesinelastTx").innerText = "timesinelastTx: " + timesinelastTx + "\n";
    document.getElementById("lastMonthTxCount").innerText = "lastMonthTxCount: " + lastMonthTxCount + "\n";
    document.getElementById("lastYearTxCount").innerText = "lastYearTxCount: " + lastYearTxCount + "\n";
    document.getElementById("averageTxInternal").innerText = "averageTxInternal: " + averageTxInternal + "\n";
})();